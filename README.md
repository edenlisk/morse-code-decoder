...
- **The user can decode a Morse message**
...
- On the terminal run this command git clone https://github.com/edenlisk/morse-code-decoder.git
...
```sh 
git https://github.com/edenlisk/morse-code-decoder.git
  ```
  ```sh 
